...
Stan helps the Data Science Pool prepare for quarterly strategy meetings, and it incorporates the meeting notes and outputs into a knowledge base for the team to reference and build upon.
...
- Project documentation: add the core docs for scope, usage, outputs, and governance
